                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <select class="form-select form-select-solid @error('room_type')is-invalid @enderror" name="room_type" id="room_type" data-control="select2" data-placeholder="Select Bed Type">
                            <option></option>
                            @foreach ($types as $i)
                                <option value="{{ $i->id }}" {{ old('room_type') == $i->id ? 'selected' : '' }}>{{ $i->name }}</option>
                            @endforeach
                        </select>
                        <!--end::Select-->
                        <!--begin::Error-->
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('room_number')is-invalid @enderror" type="text" id="room_number" name="room_number" value="{{ old('room_number') }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('room_number')
                            <span class="invalid-feedback d-block" role="alert">
