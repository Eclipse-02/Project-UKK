                        ...
                        <div class="container">
                            ...
                            <div class="text-center mb-12">
                                ...
                                <h3 class="fs-2hx text-light mb-5" id="team"
                                    data-kt-scroll-offset="{default: 100, lg: 150}">Fasilitas Hotel Kami
                                </h3>
                                <!--end::Title-->
                                <!--begin::Sub-title-->
                                <div class="fs-5 text-muted fw-bold">Hotel Insitu Memiliki Berbagai Macam Fasilitas Yang Bisa Anda Pakai
                                    <br />Di Bawah Ini Adalah Fasilitas Yang Telah Kami Sediakan 
                                </div>
                                <!--end::Sub-title=-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="tns tns-default">
                                ...
                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-300px h-300px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{ asset('source/html/theme/demo1/dist/assets/media/avatars/htl6.jpeg') }}')">
                                        </div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                            <a href="#" class="text-light fw-bolder text-hover-primary fs-3">Paul
                                                Miles</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Person-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-300px h-300px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{ asset('source/html/theme/demo1/dist/assets/media/avatars/htl1.jpeg') }}')">
                                        </div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="text-light fw-bolder text-hover-primary fs-3">Melisa Marcus</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Person-->
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 mr-5 d-flex w-300px h-300px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{ asset('source/html/theme/demo1/dist/assets/media/avatars/htl4.jpeg') }}')">
                                        </div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="text-light fw-bolder text-hover-primary fs-3">David Nilson</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Person-->
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-300px h-300px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{ asset('source/html/theme/demo1/dist/assets/media/avatars/htl3.jpeg') }}')">
                                        </div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                            <a href="#" class="text-light fw-bolder text-hover-primary fs-3">Anne
                                                Clarc</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Person-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-300px h-300px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('{{ asset('source/html/theme/demo1/dist/assets/media/avatars/htl5.jpeg') }}')">
                                        </div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="text-light fw-bolder text-hover-primary fs-3">Alice Wayde</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Person-->
                                    </div>
