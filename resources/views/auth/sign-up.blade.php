						...
						<form method="POST" action="{{ route('register') }}" class="form w-100" novalidate="novalidate">
							...
							<div class="row fv-row mb-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input class="form-control @error ('name') is-invalid @enderror form-control-lg form-control-solid" type="text" id="email" placeholder="" name="name" value="{{ old('name') }}" autocomplete="name" />
                                        @error('name')
                            ...
                            <div class="fv-row mb-7">
								...
								<input class="form-control @error ('no_hp') is-invalid @enderror form-control-lg form-control-solid" type="text" placeholder="" id="no_hp" name="no_hp" autocomplete="no_hp" />
                                    @error('no_hp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
