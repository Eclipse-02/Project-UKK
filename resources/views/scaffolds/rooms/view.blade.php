...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header cursor-pointer my-2">
        ...
        <div class="card-title m-0 flex-column">
            <h3 class="fw-bolder m-0">Room Details</h3>
            <div class="text-muted fs-7 fw-bold">Detail Ruangan</div>
        </div>
        <!--end::Card title-->
        <!--start::Button-->
        <!--start::Action-->
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Room Type</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->type->name }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->room_number }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Facility</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-12 mt-2">
                @foreach ($data->facility as $i)
                    <span class="fw-bold fs-6 text-gray-800"> - {{ $i }}</span>
                @endforeach
            </div>
            <!--begin::Label-->
        </div>
