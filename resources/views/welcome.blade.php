...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200"
                ...
                <div class="container">
                    ...
                    <form action="{{ route('registrations.create') }}" method="POST">
                        ...
                        <div class="row g-2 mt-4">
                            ...
                            <div class="col-md-1">
                                <button type="submit" class="btn btn-info on">Pesan</button>
                            </div>
                        </div>
                    </form>
                    <div class="text-center mt-15 mb-18" id="achievements"
                        ...
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="fs-5 text-gray-700 fw-bold">Dibawah Naungan Yayasan Prawitama Hotel Insitu Hadir
                            Untuk SMK WIKRAMA 1 GARUT
                            <br />Dan Juga Mempermudah Para Siswa dan Siswi Jurusan Perhotelan SMK WIKRAMA 1 GARUT Untuk
                            Memperoleh Pengalaman di Lapangan Secara Langsung.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-center">
                        ...
                        <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                style="background-image: url('source/html/theme/demo1/dist/assets/media/svg/misc/octagon.svg')">
                                <!--begin::Symbol-->
    ...
    <script>
		...
		orderForYourselfCheckbox.addEventListener('change', function () {
			if (this.checked) {
				enterNameInput.style.display = 'none';
			}
		});

		orderForSomeoneElseCheckbox.addEventListener('change', function () {
			if (this.checked) {
