<form action="{{ route('addOns.destroy', $id) }}" method="POST" class="text-center">
    @csrf
    @method('DELETE')

    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-md me-1" href="{{ route('addOns.show', $id) }}'" >
    ...
    <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-md me-1" href="{{ route('addOns.edit', $id) }}" >
