        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0 flex-column">
                    <h3 class="fw-bolder m-0">Create Promotion Code Data</h3>
                    <div class="text-muted fs-7 fw-bold">Membuat Data Kode Promosi</div>
                </div>
                <!--end::Card title-->
                <!--start::Button-->
                <!--start::Action-->
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('codes.store') }}" method="POST">
                @csrf
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('code_name')is-invalid @enderror" type="text" id="code_name" name="code_name" value="{{ old('code_name') }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('code_name')
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('discount')is-invalid @enderror" type="text" id="discount" name="discount" value="{{ old('discount') }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('discount')
                            <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control form-control-solid @error('duration')is-invalid @enderror" id="duration" name="duration" value="{{ old('duration') }}" />
                        <!--end::Input-->
                        <!--begin::Error-->
                        @error('duration')
                            <span class="invalid-feedback d-block" role="alert">
