...
@section('content')
    ...
    <div class="col-xxl-12">
        ...
        <div class="card">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form class="form" action="{{ route('facilities.store') }}" method="POST">
                @csrf
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Textarea-->
                        <textarea class="form-control form-control form-control-solid @error('desc')is-invalid @enderror" name="desc" data-kt-autosize="true">{{ old('desc') }}</textarea>
                        <!--end::Textarea-->
                        <!--begin::Error-->
                        @error('desc')
                            <span class="invalid-feedback d-block" role="alert">
