		...
		<div class="d-flex flex-column flex-root">
								...
								<div class="d-lg-block" id="kt_header_nav_wrapper">
									<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
										...
										<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
											...
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#how-it-works" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Kamar</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Fasilitas</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
			...
			<div class="mb-n10 mb-lg-n20 z-index-2">
				...
				<div class="container">
					...
					<div class="text-center mb-17">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">HOTEL INSITU</h3>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="fs-5 text-muted fw-bold">Selamat datang di hotel INSITU!
						<br />Jalan Otto Iskandardinata kampung tanjung, RT.003/RW.013, Pasawahan, Kec. Tarogong Kaler, Kabupaten Garut, Jawa Barat 44151
					</div>
						<!--end::Text-->
					</div>
					<!--end::Heading-->
					...
					<div class="tns tns-default">
						...
						<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="10000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev1" data-tns-next-button="#kt_team_slider_next1">
							...
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{ asset('source/html/theme/demo1/dist/assets/media/product-demos/htl.jpeg') }}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{ asset('source/html/theme/demo1/dist/assets/media/product-demos/htl1.jpeg') }}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{ asset('source/html/theme/demo1/dist/assets/media/product-demos/htl2.jpeg') }}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
								<img src="{{ asset('source/html/theme/demo1/dist/assets/media/product-demos/htl4.jpeg') }}" class="card-rounded shadow mw-100" alt="" />
							</div>
							<!--end::Item-->
						</div>
						<!--end::Slider-->
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="row g-2 mt-6">
							<div class="col-md">
								<input class="form-control form-control-lg" id="kt_datepicker_7" placeholder="Check-in">
							</div>
							<div class="col-md">
									<input class="form-control form-control-lg" id="kt_datepicker_8" placeholder="Check-out">
							</div>
							<div class="col-md">
						...
						<div class="text-center mt-15 mb-18" id="achievements" data-kt-scroll-offset="{default: 100, lg: 150}">
							<!--begin::Title-->
							<h3 class="fs-2hx text-white fw-bolder mb-5">TENTANG KAMI</h3>
							<!--end::Title-->
							<!--begin::Description-->
							<div class="fs-5 text-gray-700 fw-bold">Dibawah Naungan Yayasan Prawitama Hotel Insitu Hadir Untuk SMK WIKRAMA 1 GARUT
							<br />Dan Juga Mempermudah Para Siswa dan Siswi Jurusan Perhotelan SMK WIKRAMA 1 GARUT Untuk Memperoleh Pengalaman di Lapangan Secara Langsung.</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
						<!--begin::Statistics-->
							...
							<div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('source/html/theme/demo1/dist/assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="15" data-kt-countup-suffix="+">0</div>
										</div>
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-bold fs-5 lh-0">Kamar Tipe A</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('source/html/theme/demo1/dist/assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-bold fs-5 lh-0">Kamar Tipe B</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('source/html/theme/demo1/dist/assets/media/svg/misc/octagon.svg')">
									...
									<div class="mb-0">
										...
										<!--end::Value-->
										<!--begin::Label-->
										<span class="text-gray-600 fw-bold fs-5 lh-0">Kamar Tipe C</span>
										<!--end::Label-->
									</div>
									<!--end::Info-->
								</div>
			...
			<div class="mt-20 mb-n20 position-relative z-index-2">
				...
				<div class="container">
					...
					<div class="text-center mb-17">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="clients" data-kt-scroll-offset="{default: 125, lg: 150}">Apa Kata Klien Kami?</h3>
						<!--end::Title-->
						<!--begin::Description-->
						<div class="fs-5 text-muted fw-bold">Banyak Klien yang Sudah Mencoba Pelayanan Hotel Kami
						<br />Di Bawah ini Adalah Pendapat Mereka</div>
						<!--end::Description-->
					</div>
					<!--end::Heading-->
					<!--begin::Row-->
					...
					<div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
						...
						<div class="my-2 me-5">
							...
							<span class="fw-normal">Dapatkan Pelayanan Maksimal!</span></div>
							<!--end::Title-->
							<!--begin::Description-->
							<div class="fs-6 fs-lg-5 text-white fw-bold opacity-75">Pesan Kamar Sekarang dan Dapatkan Pelayanan yang Sangat Memuaskan</div>
							<!--end::Description-->
						</div>
						<!--end::Content-->
						<!--begin::Link-->
						<a href="https://1.envato.market/EA4JP" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Pesan Kamar Disini!</a>
						<!--end::Link-->
					</div>
					<!--end::Highlight-->
				</div>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9 mb-10">
									...
									<a href="https://keenthemes.com/support" class="text-white opacity-50 text-hover-primary">+628XXXXXXXXXX</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
								<!--begin::Block-->
